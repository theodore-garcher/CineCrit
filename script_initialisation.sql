...
CREATE TABLE Critique(
   ...
   PRIMARY KEY(idCrit),
   UNIQUE(idFilm),s
   FOREIGN KEY(idFilm) REFERENCES Film(idFilm) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE Commentaire(
   ...
   PRIMARY KEY(idCom),
   FOREIGN KEY(idUser) REFERENCES Utilisateur(idUser) ON DELETE CASCADE ON UPDATE CASCADE,
   FOREIGN KEY(idCrit) REFERENCES Critique(idCrit) ON DELETE SET NULL ON UPDATE CASCADE
);
